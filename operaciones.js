...
//SONIDOS
const sonido_disparo = new Audio('./sonidos/disparo.wav');
sonido_disparo.volume = 0.1;

const sonido_enemigo_destruido = new Audio('./sonidos/enemigo_destruido.wav');
sonido_enemigo_destruido.volume = 0.060;

const sonido_player_dano = new Audio('./sonidos/player_dano.wav');
